...
//
//     final pendingApoinmentList = pendingApoinmentListFromJson(jsonString);

import 'dart:convert';

List<PendingApoinmentList> pendingApoinmentListFromJson(String str) =>
    List<PendingApoinmentList>.from(
        json.decode(str).map((x) => PendingApoinmentList.fromJson(x)));

String pendingApoinmentListToJson(List<PendingApoinmentList> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class PendingApoinmentList {
  int id;
  ...
  factory PendingApoinmentList.fromJson(Map<String, dynamic> json) =>
      PendingApoinmentList(
        id: json["id"],
